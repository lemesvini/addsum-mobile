...
const buttonVariants = cva(
  ...
  ),
  {
    variants: {
      variant: {
        default: cn(
          "bg-primary active:bg-primary/90 shadow-lg shadow-card",
        ...
        secondary: cn(
          "bg-secondary active:bg-secondary/80 shadow-lg shadow-black/5 ",
          Platform.select({ web: "hover:bg-secondary/80" }),
        ),
        ghost: cn(
          "active:bg-transparent dark:active:bg-transparent",
          Platform.select({
            web: "hover:bg-transparent dark:hover:bg-transparent",
          }),
        ),
        link: "",
        header:
          "bg-button-primary active:bg-button-primary/90 shadow-sm shadow-black/5",
      },
      size: {
        default: cn(
...
function Button({ className, variant, size, children, ...props }: ButtonProps) {
  const content: React.ComponentProps<typeof Pressable>["children"] =
